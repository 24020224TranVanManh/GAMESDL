...
// Cập nhật vị trí của Enemy (di chuyển xuống)
bool Enemy::Update()
{
    posY += velY;
...
// Cập nhật vị trí của AdvancedEnemy (di chuyển ngang)
...
// Vẽ AdvancedEnemy và đạn của nó
...
// Quái bắn đạn thẳng xuống dưới với tốc độ nhỏ hơn 1
void AdvancedEnemy::Shoot(SDL_Renderer* renderer)
{
    ...
    if (current_time - last_shot_time >= shoot_delay) {
        ...
        if (new_pow->LoadImg("dan/1.png", renderer)) {
            ...
            new_pow->SetDamage(1);
            new_pow->SetDirection(0, 0.5f); // Tốc độ đạn nhỏ hơn 1
...
// Định nghĩa hàm SetPosition cho AdvancedEnemy
